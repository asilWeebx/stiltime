    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('customer', 'Mijoz'), ('barber', 'Sartarosh'), ('salon_owner', 'Salon egasi'), ('superadmin', 'SuperAdmin')], default='customer', max_length=20)),
                ...
                ('reminder_minutes', models.IntegerField(choices=[(15, '15 daqiqa'), (30, '30 daqiqa'), (45, '45 daqiqa'), (60, '1 soat')], default=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vip_since', models.DateField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('referred_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.customerprofile')),
